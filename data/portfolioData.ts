...
export const projects: Project[] = [
  {
    ...
    metrics: ['RESTful API', 'MySQL', 'JWT Authentication', 'Realtime Chat', 'GoongMap', 'AI Agent'],
    badges: ['Laravel', 'PHP', 'Nuxt 3', 'JWT', 'Reverb', 'AI Agent', 'VNPay', 'ZaloPay', 'GoongMap', 'Cloudinary'],
  },
  {
    id: 'room-rental',
